<?php if (!defined('THINK_PATH')) exit();?><form class="layui-form" >
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" name="banner_name" value="<?php echo ($banner_info["banner_name"]); ?>" placeholder="请输入Banner名称" autocomplete="off" class="layui-input">
    </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      ...
      <img id="img_upload" src="/newapp1<?php echo ($banner_info["banner_img"]); ?>" style="width: 200px;height: 100px;">
    </div>
  </div>
  <div class="layui-form-item">
  ...
  <div class="layui-form-item">
    <div class="layui-input-block">
      <input type="hidden" name="id" value="<?php echo ($banner_info["id"]); ?>"/>
