 ...
 * Time: 9:37
 */
if(file_exists(__DIR__.'/dev_localhost.php') AND 'dev' == APP_STATUS) {
    return require(__DIR__ . '/dev_localhost.php');
}
return array(
    //数据库连接配置
    'DB_TYPE' => 'mysql',
    ...
    //读取分公司业务员  $arr=array('city'=>$city);
    'BASE_updateAllSalesman'=>'http://base.fang-crm.com/Api/Index/updateAllSalesman?key=356o192c191db04c54513b0lc28d46ee63954iab',
    //批量获取用户姓名   $arr=array('user_ids'=>$user_ids);
    'BASE_getUserNames'=>'http://base.fang-crm.com/Api/Index/getUserNames?key=356o192c191db04c54513b0lc28d46ee63954iab',
    //根据条件查询部门信息  $arr=array('where'=>$where,"type"=>$type);
    'BASE_getDepartmentByWhere'=>'http://base.fang-crm.com/Api/Index/getDepartmentByWhere?key=356o192c191db04c54513b0lc28d46ee63954iab',
    //获取来源渠道
    'base_getBrand' => 'http://base.fang-crm.com/Api/Index/getBrand?key=356o192c191db04c54513b0lc28d46ee63954iab',
    //修改个人信息
    'BASE_editUser'=>'http://base.fang-crm.com/Api/Index/editUser?key=356o192c191db04c54513b0lc28d46ee63954iab',
    //修改密码
    'BASE_editPassword'=>'http://base.fang-crm.com/Api/Index/editPassword?key=356o192c191db04c54513b0lc28d46ee63954iab',

    //获取下级业务员
    'BASE_getSubUserByUserId'=>'http://base.fang-crm.com/Api/Index/getSubUserByUserId?key=356o192c191db04c54513b0lc28d46ee63954iab',
    //获取所在城市
    'BASE_getCityByUserid'=>'http://base.fang-crm.com/Api/Index/getCityByUserid?key=356o192c191db04c54513b0lc28d46ee63954iab',
    //获取下属部门列表
    ...
    //获取下属部门id
    'BASE_getSubDepartmentId'=>'http://base.fang-crm.com/base/Api/Index/getSubDepartmentId?key=356o192c191db04c54513b0lc28d46ee63954iab',
    ...
    'API_URl'=>'http://service.fang-crm.com/Home/Api/Api?key=356aa92b71o3a06c51534d18c75u46e63as428ab',
    'OCDC_URl'=>'http://ocdc.fang-crm.com/Api/Index/save?key=356a192b7oo3b06c54574d18c28d46e63as428ab',
    'OCDC_CALLBACK_URl'=>'http://ocdc.fang-crm.com/Api/Index/pushCallback?key=356a192b7oo3b06c54574d18c28d46e63as428ab',
    //查看客户保留时间
    'LOOK_RETAIN_TIME'=>15,
    //客户被查看上限
    ...
    'IMAGE_PATH'=>"http://sale.fang-crm.com",
