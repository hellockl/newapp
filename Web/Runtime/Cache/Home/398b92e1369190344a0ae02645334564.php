...
<!--    <script src="text/javascript">
        $(function(){
            $(".next_01").click(function(){
                var one = $(".one input").val();
                var one_01 = $(".one_01 input").val();
                var one_02 = $(".one_02 input").val()
                $.common.ajaxPost("User/editPassword",
                                    {
                                        ...
                                        0==a.errorCode?(layer.msg("密码修改成功"),setTimeout(function(){window.location.href="User/editPassword"},1500)):layer.msg(a.errorMsg)}
                                )
    ...
    <div class="inside">
        <div class="psd">
            <ul>
                ...
                <li class="secondary_pas" style="color: rgb(51, 51, 51); border-bottom: 1px solid transparent;">资金密码</li>
            </ul>
        </div>
        <div class="psd_02">
...
<!--                <div class="patterning_code">
            ...
            <div class="content_02" style="display: none;">
                ...
                <div class="tow_01">
                    <span><b>*</b>新资金密码：</span><input placeholder="密码长度6-16位至少包含数字字母符号中两种" type="password">
                    <b class="b_11">新资金密码不能为空</b>
                    <b class="b_12">新资金密码不符要求，请按提示输入</b>
                </div>
                <div class="tow_02">
                    <span><b>*</b>确认新资金密码：</span><input placeholder="确认两次密码输入一致" type="password">
